...
{
	/// <summary> Draws a pointer of hand to indicate to which object is pointed. </summary>
	[DisallowMultipleComponent]
	[RequireComponent(typeof(MeshRenderer), typeof(MeshFilter))]
	public sealed class HandSpotPointer : MonoBehaviour
	{
		const string LOG_TAG = "Wave.Essence.Tracker.Model.Demo.HandSpotPointer";
		...
		const float kDefaultPointerDistance = 0.1f;

		[Tooltip("Current pointer distance in meters.")]
		[SerializeField]
		private float m_PointerDistanceInMeters = 0.1f;
		...
		{
			pointerOuterDiameter = m_MinimalPointerDiameter + (m_PointerDistanceInMeters * pointerGrowthMultiple);
			/*DEBUG("UpdatePointerDiameter() pointerOuterDiameter: " + pointerOuterDiameter
				+ ", m_MinimalPointerDiameter: " + m_MinimalPointerDiameter
				+ ", m_PointerDistanceInMeters: " + m_PointerDistanceInMeters);*/
		}
