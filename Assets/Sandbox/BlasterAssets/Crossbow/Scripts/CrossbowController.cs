...
namespace StrikerLink.Unity.Runtime.Samples
{
    public class CrossbowController : MonoBehaviour
    {
        ...
        void HandleInputs()
        {
            ...
            if(device.GetButtonDown(Shared.Devices.DeviceFeatures.DeviceButton.MenuTop) || device.GetButtonDown(Shared.Devices.DeviceFeatures.DeviceButton.MenuBottom))
            {
